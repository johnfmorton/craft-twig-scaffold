...
return [
    ...
    'Partial template: {label}' => 'Partial template: {label}',
    'Partial instructions' => 'Suggested location: {path}. Craft renders it for each block of this type; the block is available as `{variable}`.',
